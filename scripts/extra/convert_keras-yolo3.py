...
And converts the rotated-horizontal-detection-results from the annotation files
...
group.add_argument('--dr',
    type=str,
    default=None,
    help="The annotation file that refers to rotated-horizontal-detection-results in (keras-yolo3 format)")
        ...
        with open(output_file_path, 'w') as out_f:
            for bbox in annot[1:]:
                if ARGS.gt:
                    ...
                    # Here we are dealing with rotated-horizontal-detection-results annotations
