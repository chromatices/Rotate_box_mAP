...
## This script ensures same number of files in ground-truth and rotated-horizontal-detection-results folder.
## When you encounter file not found error, it's usually because you have
## mismatched numbers of ground-truth and rotated-horizontal-detection-results files.
## You can use this script to move ground-truth and rotated-horizontal-detection-results files that are
...
print('total rotated-horizontal-detection-results files:', len(dr_files))
print()
...
if dr_backup:
    print('total rotated-horizontal-detection-results backup files:', len(dr_backup))
