...
if __name__ == "__main__":
    from utils.dataset_reader.eo_dataset import convert_eo_dataset_to_common_interface
    ...
    annotations = convert_eo_dataset_to_common_interface()
    detection_anno = DetectionAnnotations(annotations)
    coco_converter = COCOConverter(detection_anno)
    # coco_converter.save("eo-dataset_reader.json")
