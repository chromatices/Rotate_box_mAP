...
def forward_convert(coordinate: np.array, with_label=True)-> np.array:
    """
...
def back_forward_convert(coordinate:np.array, with_label=True)-> np.array:
    """
...
if __name__ == '__main__':
    ...
    coord3 = back_forward_convert(coord2)
    print(coord)
    print(coord2)
    print(coord3)
